    ...
    <div class="row">
                    ...
                    <div class="tab-content">
                            ...
                            @foreach($language as $k)
                                ...
                                <div class="tab-pane" id="tabs-content-{!! $country->language !!}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="name{!! $country->language !!}" name="name{!! $country->language !!}" data-id="{!! (!empty($result))?$result->id:0 !!}" data-lang="{!! $country->language !!}" data-url="{!! url('admin/article/check-link') !!}" class="form-control" value="{!! (!empty($result) && $result != null && !empty($result->metaData[$i]))?$result->metaData[$i]->name:old('name'.$country->language) !!}" placeholder="Name...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="tab-pane active" id="tabs-content-general">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="tags" name="tags" class="input-tags" value="{!! (!empty($result))?$tags:"" !!}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <!-- Meta Data Content -->
                <form action="{!! url('admin/article/meta-data') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    <!-- Default Tabs -->
                    <ul class="nav nav-tabs" data-toggle="tabs">
            ...
            <div class="block">
                ...
                <!-- Product Images Content -->
                <div class="block-section">
                    <form id="multiple-dropzone" data-multiple="true" data-maxfile="5" action="{!! url('admin/article/multiple-images') !!}" class="dropzone images">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                        <div class="dropzone-previews"></div>
                        <div class="fallback"> <!-- this is the fallback if JS isn't working -->
