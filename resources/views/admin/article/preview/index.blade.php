...
@section('content')
    <div class="content-header">
        <div class="header-section">
            <h1><i class="fa fa-file-text"></i> Article<br><small>Your Article Center</small></h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Pages</li>
        <li>Article Center</li>
        <li><a href="{!! url('admin/article/list') !!}">View Article</a></li>
    </ul>
    <!-- Quick Stats -->
    ...
    <div class="block full">
        ...
        <div class="block-title">
            ...
            <h2><strong>All</strong> Article</h2>
        </div>
