...
@section('content')
    <div class="content-header">
        <div class="header-section">
            <h1>{{--<i class="fa fa-spinner fa-3x fa-spin"></i>--}}<i class="gi gi-pencil"></i> Block<br><small>Create and Edit Block</small></h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Pages</li>
        <li><a href="{!! url('admin/block/list') !!}">Block Center</a></li>
        <li>{!! $action !!} Block</li>
    </ul>
    @if($action == 'Edit')
        <div class="row text-center">
            <div class="col-sm-6 col-lg-3">
                <a href="{!! url('admin/block/create') !!}" class="widget widget-hover-effect2">
                    <div class="widget-extra themed-background-success">
                        <h4 class="widget-content-light"><strong>Add New</strong> Block</h4>
                    </div>
    ...
    <div class="row">
                    ...
                    <div class="tab-content">
                            ...
                            @foreach($language as $k)
                                ...
                                <div class="tab-pane" id="tabs-content-{!! $country->language !!}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="name{!! $country->language !!}" name="name{!! $country->language !!}" data-id="{!! (!empty($result))?$result->id:0 !!}" data-lang="{!! $country->language !!}" data-url="{!! url('admin/block/check-link') !!}" class="form-control" value="{!! (!empty($result) && $result != null && !empty($result->metaData[$i]))?$result->metaData[$i]->name:old('name'.$country->language) !!}" placeholder="Name...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="tab-pane active" id="tabs-content-general">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="name" name="name" data-lang="general" data-id="{!! (!empty($result))?$result->id:0 !!}" data-url="{!! url('admin/block/check-link') !!}" class="form-control" value="{!! (!empty($result))?$result->name:old('name') !!}" placeholder="Name...">
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <!-- Meta Data Content -->
                <form action="{!! url('admin/block/meta-data') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    <!-- Default Tabs -->
                    <ul class="nav nav-tabs" data-toggle="tabs">
            ...
            <div class="block">
                ...
                <div class="block-section">
                    <form id="my-awesome-dropzone" data-multiple="false" data-maxfile="1" action="{!! url('admin/block/images') !!}" class="dropzone images">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    ...
                    <table class="table table-bordered table-striped table-vcenter">
                        ...
                        @if(!empty($result) && $result != null && $result->images != null)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn btn-xs btn-danger delete-image" data-url="{!! url('admin/block/delete-image') !!}" data-id="{!! $result->id !!}" data-token="{!! csrf_token() !!}"><i class="fa fa-trash-o"></i> Delete</a>
                                </td>
                            </tr>
                        @endif
                        </tbody>
            ...
            <div class="block">
                ...
                <!-- Product Images Content -->
                <div class="block-section">
                    <form id="multiple-dropzone" data-multiple="true" data-maxfile="5" action="{!! url('admin/block/multiple-images') !!}" class="dropzone images">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                        <div class="dropzone-previews"></div>
                        <div class="fallback"> <!-- this is the fallback if JS isn't working -->
