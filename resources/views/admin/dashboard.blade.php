...
<div class="content-header content-header-media">
    ...
    <img src="/backend/img/placeholders/headers/dashboard_header.jpg" alt="header image" class="animation-pulseSlow">
</div>
...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <!-- Widget -->
        <a href="{!! url('admin/article/create') !!}" class="widget widget-hover-effect1">
    ...
    <div class="col-sm-6 col-lg-3">
        <!-- Widget -->
        <a href="{!! url('admin/contact/index') !!}}" class="widget widget-hover-effect1">
            <div class="widget-simple">
        ...
        <a href="page_comp_charts.html" class="widget widget-hover-effect1">
            <div class="widget-simple">
                ...
                <div class="pull-right">
                    <!-- Jquery Sparkline (initialized in /backend/js/pages/index.js), for more examples you can check out http://omnipotent.net/jquery.sparkline/#s-about -->
                    ...
                    <ul class="timeline-list">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="/backend/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                            <img src="/backend/img/placeholders/photos/photo1.jpg" alt="image">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a href="/backend/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                            <img src="/backend/img/placeholders/photos/photo22.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="active">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="/backend/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                            <img src="/backend/img/placeholders/photos/photo23.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="widget">
            <div class="widget-advanced widget-advanced-alt">
                ...
                <div class="widget-header text-center themed-background">
                    ...
                    <!-- Flot Charts (initialized in /backend/js/pages/index.js), for more examples you can check out http://www.flotcharts.org/ -->
        ...
        <div class="widget">
            <div class="widget-advanced widget-advanced-alt">
                ...
                <div class="widget-header text-left">
                    ...
                    <img src="/backend/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                    ...
                    <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                        <div class="row">
                            <div class="col-xs-6 col-sm-3">
                                <a href="/backend/img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                    <img src="/backend/img/placeholders/photos/photo15.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="/backend/img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                    <img src="/backend/img/placeholders/photos/photo5.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="/backend/img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                    <img src="/backend/img/placeholders/photos/photo6.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="/backend/img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
                                    <img src="/backend/img/placeholders/photos/photo13.jpg" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
