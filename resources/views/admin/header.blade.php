<header class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav-custom pull-right">
        ...
        <li class="dropdown">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                <img src="/backend/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                ...
                <li>
                    ...
                    <a href="{!! url('admin/contact/index') !!}">
                        ...
                        <span class="badge pull-right">{!! $message !!}</span>
                        Messages
                    </a>
                ...
                <li>
                    ...
                    <a href="{!! url('admin/user/logout') !!}"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                </li>
