...
@section('content')
    <div class="content-header">
        <div class="header-section">
            <h1>{{--<i class="fa fa-spinner fa-3x fa-spin"></i>--}}<i class="gi gi-pencil"></i> Categories Product<br><small>Create and Edit Categories Product</small></h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Pages</li>
        <li><a href="{!! url('admin/products/category') !!}">Categories Product Center</a></li>
        <li>{!! $action !!} Categories Product</li>
    </ul>
    @if($action == 'Edit')
            ...
            <div class="col-sm-6 col-lg-3">
                <a href="{!! url('admin/products/category/create') !!}" class="widget widget-hover-effect2">
                    <div class="widget-extra themed-background-success">
                        <h4 class="widget-content-light"><strong>Add New</strong> Categories Product</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <form action="{!! url('admin/products/category/create') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    ...
                    <div class="tab-content">
                            ...
                            @foreach($language as $k)
                                ...
                                <div class="tab-pane" id="tabs-content-{!! $country->language !!}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="name{!! $country->language !!}" name="name{!! $country->language !!}" data-id="{!! (!empty($result))?$result->id:0 !!}" data-lang="{!! $country->language !!}" data-url="{!! url('admin/products/category/check-link') !!}" class="form-control" value="{!! (!empty($result) && $result != null && !empty($result->metaData[$i]))?$result->metaData[$i]->name:old('name'.$country->language) !!}" placeholder="Name...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="tab-pane active" id="tabs-content-general">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="name" name="name" data-lang="general" data-id="{!! (!empty($result))?$result->id:0 !!}" data-url="{!! url('admin/products/category/check-link') !!}" class="form-control" value="{!! (!empty($result))?$result->name:old('name') !!}" placeholder="Name...">
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <!-- Meta Data Content -->
                <form action="{!! url('admin/products/category/meta-data') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    <!-- Default Tabs -->
                    <ul class="nav nav-tabs" data-toggle="tabs">
