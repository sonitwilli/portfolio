...
@section('content')
    <div class="content-header">
        <div class="header-section">
            <h1>{{--<i class="fa fa-spinner fa-3x fa-spin"></i>--}}<i class="gi gi-pencil"></i> Products<br><small>Create and Edit Products</small></h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Pages</li>
        <li><a href="{!! url('admin/products/list') !!}">Products Center</a></li>
        <li>{!! $action !!} Products</li>
    </ul>
    @if($action == 'Edit')
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <form action="{!! url('admin/products/create') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    ...
                    <div class="tab-content">
                            ...
                            @foreach($language as $k)
                                ...
                                <div class="tab-pane" id="tabs-content-{!! $country->language !!}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="name{!! $country->language !!}" name="name{!! $country->language !!}" data-id="{!! (!empty($result))?$result->id:0 !!}" data-lang="{!! $country->language !!}" data-url="{!! url('admin/products/check-link') !!}" class="form-control" value="{!! (!empty($result) && $result != null && !empty($result->metaData[$i]))?$result->metaData[$i]->name:old('name'.$country->language) !!}" placeholder="Name...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="tab-pane active" id="tabs-content-general">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="name" name="name" data-lang="general" data-id="{!! (!empty($result))?$result->id:0 !!}" data-url="{!! url('admin/products/check-link') !!}" class="form-control" value="{!! (!empty($result))?$result->name:old('name') !!}" placeholder="Name...">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" readonly id="slug" name="slug" class="form-control" value="{!! (!empty($result))?$result->slug:old('slug') !!}" placeholder="Slug">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="category" id="category" class="select-chosen" data-placeholder="Choose category..." style="width:250px;">
                                {!! $category !!}
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" id="price" name="price" class="form-control" value="{!! (!empty($result))?number_format($result->price):old('price') !!}" placeholder="0,00">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="sale">Sale</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-percent"></i></div>
                                <input type="text" id="sale" name="sale" class="form-control" value="{!! (!empty($result))?number_format($result->sale):old('sale') !!}" placeholder="0">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="text" id="qty" name="qty" class="form-control" value="{!! (!empty($result))?number_format($result->qty):old('qty') !!}" placeholder="0">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="radio-inline" for="product-condition-new">
                                <input type="radio" id="product-condition-new" name="condition" value="1" @if(!empty($result) && $result->condition == 1) checked @elseif(empty($result)) checked @endif> New
                            </label>
                            <label class="radio-inline" for="product-condition-used">
                                <input type="radio" id="product-condition-used" name="condition" value="2" @if(!empty($result) && $result->condition == 2) checked @endif> Used
                            </label>
                            <label class="radio-inline" for="product-condition-stock">
                                <input type="radio" id="product-condition-stock" name="condition" value="3" @if(!empty($result) && $result->condition == 3) checked @endif> Out of Stock
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <!-- Meta Data Content -->
                <form action="{!! url('admin/products/meta-data') !!}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    <!-- Default Tabs -->
                    <ul class="nav nav-tabs" data-toggle="tabs">
            ...
            <div class="block">
                ...
                <div class="block-section">
                    <form id="my-awesome-dropzone" data-multiple="false" data-maxfile="1" action="{!! url('admin/products/images') !!}" class="dropzone images">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                    ...
                    <table class="table table-bordered table-striped table-vcenter">
                        ...
                        @if(!empty($result) && $result != null && $result->images != null)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn btn-xs btn-danger delete-image" data-url="{!! url('admin/products/delete-image') !!}" data-id="{!! $result->id !!}" data-token="{!! csrf_token() !!}"><i class="fa fa-trash-o"></i> Delete</a>
                                </td>
                            </tr>
                        @endif
                        </tbody>
            ...
            <div class="block">
                ...
                <!-- Product Images Content -->
                <div class="block-section">
                    <form id="multiple-dropzone" data-multiple="true" data-maxfile="5" action="{!! url('admin/products/multiple-images') !!}" class="dropzone images">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{!! (!empty($result))?$result->id:0 !!}">
                        <div class="dropzone-previews"></div>
                        <div class="fallback"> <!-- this is the fallback if JS isn't working -->
