...
<img src="/backend/img/placeholders/backgrounds/login_full_bg.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="login-title text-center">
        <h1>
            <i class="gi gi-flash"></i> <strong>ADMIN LOGIN</strong><br><small>Please <strong>Login</strong> or <strong>Register</strong></small>
    ...
    <div class="block push-bit">
        <!-- Login Form -->
        <form action="{!! url('admin/sign-in') !!}" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            @if(Session::get('error'))<div class="has-error"><div class="help-block animation-slideDown text-center">{{ Session::get('error') }}</div></div>@endif
        ...
        <!-- Reminder Form -->
        <form action="{!! url('admin/forgot-password') !!}" method="post" id="form-reminder" class="form-horizontal form-bordered form-control-borderless display-none">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
        ...
        <!-- Register Form -->
        <form action="{!! url('admin/register') !!}" method="post" id="form-register" class="form-horizontal form-bordered form-control-borderless display-none">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            @if(Session::get('error_register'))<div class="has-error"><div class="help-block animation-slideDown text-center">{{ Session::get('error_register') }}</div></div>@endif
            <div class="form-group">
                <div class="col-xs-6">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="gi gi-user"></i></span>
                        <input type="text" id="register-firstname" name="register-firstname" value="{{ old('register-firstname') }}" class="form-control input-lg" placeholder="Firstname">
                    </div>
                </div>
                <div class="col-xs-6">
...
<script src="/backend/js/pages/login.js"></script>
